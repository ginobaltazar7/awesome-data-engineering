...
Monitors currently running sessions
in different scenarios like CPU, Blocking
Requires 'sp_whoisactive' stored procedure
Credit to Bhuvanesh BhuviTheDataGuy 
*******************************************************************************************/ 
